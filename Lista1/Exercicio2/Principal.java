...
//
// 2. Adição de uma nova classe ao exercício anterior. Explique, com um comentário
...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        historico.salvarResultado(calc.resultado());

        Calculadora calc2 = new Calculadora(2, 1, 0);

        historico.salvarResultado(calc2.resultado());
